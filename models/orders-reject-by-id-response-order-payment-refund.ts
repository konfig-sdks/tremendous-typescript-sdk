 ...
 * @export
 * @interface OrdersRejectByIdResponseOrderPaymentRefund
 */
export interface OrdersRejectByIdResponseOrderPaymentRefund {
    /**
     * Total amount of the order refunds (in USD)
     * @type {number}
     * @memberof OrdersRejectByIdResponseOrderPaymentRefund
     */
    'total': number;
}
