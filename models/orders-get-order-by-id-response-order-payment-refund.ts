 ...
 * @export
 * @interface OrdersGetOrderByIdResponseOrderPaymentRefund
 */
export interface OrdersGetOrderByIdResponseOrderPaymentRefund {
    /**
     * Total amount of the order refunds (in USD)
     * @type {number}
     * @memberof OrdersGetOrderByIdResponseOrderPaymentRefund
     */
    'total': number;
}
