 ...
 * 
 * @export
 * @interface RewardWithoutLinkValue
 */
export interface RewardWithoutLinkValue {
    /**
     * Amount of the reward
     * @type {number}
     * @memberof RewardWithoutLinkValue
     */
    'denomination': number;
    /**
