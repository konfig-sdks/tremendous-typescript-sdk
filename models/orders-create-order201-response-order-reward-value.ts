 ...
 * 
 * @export
 * @interface OrdersCreateOrder201ResponseOrderRewardValue
 */
export interface OrdersCreateOrder201ResponseOrderRewardValue {
    /**
     * Amount of the reward
     * @type {number}
     * @memberof OrdersCreateOrder201ResponseOrderRewardValue
     */
    'denomination': number;
    /**
