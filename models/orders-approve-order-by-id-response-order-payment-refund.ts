 ...
 * @export
 * @interface OrdersApproveOrderByIdResponseOrderPaymentRefund
 */
export interface OrdersApproveOrderByIdResponseOrderPaymentRefund {
    /**
     * Total amount of the order refunds (in USD)
     * @type {number}
     * @memberof OrdersApproveOrderByIdResponseOrderPaymentRefund
     */
    'total': number;
}
