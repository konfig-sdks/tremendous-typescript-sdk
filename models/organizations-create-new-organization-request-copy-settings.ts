 ...
 * @export
 * @interface OrganizationsCreateNewOrganizationRequestCopySettings
 */
export interface OrganizationsCreateNewOrganizationRequestCopySettings {
    /**
     * Copy over the campaigns from the current organization to the new organization. Defaults to `false`.
     * @type {boolean}
     * @memberof OrganizationsCreateNewOrganizationRequestCopySettings
     */
    'campaigns'?: boolean;
    /**
