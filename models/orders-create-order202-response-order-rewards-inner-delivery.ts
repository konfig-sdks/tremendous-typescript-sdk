 ...
 * @export
 * @interface OrdersCreateOrder202ResponseOrderRewardsInnerDelivery
 */
export interface OrdersCreateOrder202ResponseOrderRewardsInnerDelivery {
    /**
     ...
     * @type {string}
     * @memberof OrdersCreateOrder202ResponseOrderRewardsInnerDelivery
     */
    'method': OrdersCreateOrder202ResponseOrderRewardsInnerDeliveryMethodEnum;
    /**
     ...
     * @memberof OrdersCreateOrder202ResponseOrderRewardsInnerDelivery
     */
    'status': OrdersCreateOrder202ResponseOrderRewardsInnerDeliveryStatusEnum;
    /**
...
type OrdersCreateOrder202ResponseOrderRewardsInnerDeliveryMethodEnum = 'EMAIL' | 'LINK' | 'PHONE'
type OrdersCreateOrder202ResponseOrderRewardsInnerDeliveryStatusEnum = 'SCHEDULED' | 'FAILED' | 'SUCCEEDED' | 'PENDING'
