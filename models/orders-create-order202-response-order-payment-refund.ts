 ...
 * @export
 * @interface OrdersCreateOrder202ResponseOrderPaymentRefund
 */
export interface OrdersCreateOrder202ResponseOrderPaymentRefund {
    /**
     * Total amount of the order refunds (in USD)
     * @type {number}
     * @memberof OrdersCreateOrder202ResponseOrderPaymentRefund
     */
    'total': number;
}
