 ...
 * 
 * @export
 * @interface MembersCreateNewMemberRequest
 */
export interface MembersCreateNewMemberRequest {
    /**
     * Email address of the member
     * @type {string}
     * @memberof MembersCreateNewMemberRequest
     */
    'email': string;
    /**
     ...
     * @memberof MembersCreateNewMemberRequest
     */
    'role': MembersCreateNewMemberRequestRoleEnum;
}

type MembersCreateNewMemberRequestRoleEnum = 'MEMBER' | 'ADMIN'
