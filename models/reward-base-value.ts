 ...
 * 
 * @export
 * @interface RewardBaseValue
 */
export interface RewardBaseValue {
    /**
     * Amount of the reward
     * @type {number}
     * @memberof RewardBaseValue
     */
    'denomination': number;
    /**
