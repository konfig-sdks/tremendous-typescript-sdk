...
import { ProductsGetListResponseProductsInnerCountriesInner } from './products-get-list-response-products-inner-countries-inner';
import { ProductsGetListResponseProductsInnerSkusInner } from './products-get-list-response-products-inner-skus-inner';
 ...
 * @export
 * @interface ProductsGetListResponseProductsInner
 */
export interface ProductsGetListResponseProductsInner {
    /**
     * Detailed description of the product. Mostly used for products with a `category` of `charities`.
     * @type {string}
     * @memberof ProductsGetListResponseProductsInner
     */
    'description': string;
    /**
     * 
     ...
     * @memberof ProductsGetListResponseProductsInner
     */
    'category': ProductsGetListResponseProductsInnerCategoryEnum;
    /**
     ...
     * @type {Array<ProductsGetListResponseProductsInnerSkusInner>}
     * @memberof ProductsGetListResponseProductsInner
     */
    'skus'?: Array<ProductsGetListResponseProductsInnerSkusInner>;
    /**
     * Available currencies for this product
     * @type {Array<string>}
     * @memberof ProductsGetListResponseProductsInner
     */
    'currency_codes': Array<ProductsGetListResponseProductsInnerCurrencyCodesEnum>;
    /**
     * List of countries in which this product is available to recipients.
     * @type {Array<ProductsGetListResponseProductsInnerCountriesInner>}
     * @memberof ProductsGetListResponseProductsInner
     */
    'countries': Array<ProductsGetListResponseProductsInnerCountriesInner>;
    /**
