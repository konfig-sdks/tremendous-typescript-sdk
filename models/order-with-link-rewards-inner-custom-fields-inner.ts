 ...
 * @export
 * @interface OrderWithLinkRewardsInnerCustomFieldsInner
 */
export interface OrderWithLinkRewardsInnerCustomFieldsInner {
    /**
     * Tremendous ID of the custom field
     * @type {string}
     * @memberof OrderWithLinkRewardsInnerCustomFieldsInner
     */
    'id'?: string;
    /**
