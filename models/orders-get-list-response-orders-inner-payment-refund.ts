 ...
 * @export
 * @interface OrdersGetListResponseOrdersInnerPaymentRefund
 */
export interface OrdersGetListResponseOrdersInnerPaymentRefund {
    /**
     * Total amount of the order refunds (in USD)
     * @type {number}
     * @memberof OrdersGetListResponseOrdersInnerPaymentRefund
     */
    'total': number;
}
