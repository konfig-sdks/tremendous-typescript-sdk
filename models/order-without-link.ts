...
import { OrderWithoutLinkPayment } from './order-without-link-payment';
import { OrderWithoutLinkReward } from './order-without-link-reward';
...
type OrderWithoutLinkStatusEnum = 'CANCELED' | 'CART' | 'EXECUTED' | 'FAILED' | 'PENDING APPROVAL' | 'PENDING INTERNAL PAYMENT APPROVAL'
