 ...
 * 
 * @export
 * @interface OrdersRejectByIdResponseOrderRewardValue
 */
export interface OrdersRejectByIdResponseOrderRewardValue {
    /**
     * Amount of the reward
     * @type {number}
     * @memberof OrdersRejectByIdResponseOrderRewardValue
     */
    'denomination': number;
    /**
