 ...
 * 
 * @export
 * @interface OrdersApproveOrderByIdResponseOrderRewardValue
 */
export interface OrdersApproveOrderByIdResponseOrderRewardValue {
    /**
     * Amount of the reward
     * @type {number}
     * @memberof OrdersApproveOrderByIdResponseOrderRewardValue
     */
    'denomination': number;
    /**
