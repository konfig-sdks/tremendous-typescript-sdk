 ...
 * @export
 * @interface OrdersGetOrderByIdResponseOrderRewardCustomFieldsInner
 */
export interface OrdersGetOrderByIdResponseOrderRewardCustomFieldsInner {
    /**
     * Tremendous ID of the custom field
     * @type {string}
     * @memberof OrdersGetOrderByIdResponseOrderRewardCustomFieldsInner
     */
    'id'?: string;
    /**
