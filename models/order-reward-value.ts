 ...
 * 
 * @export
 * @interface OrderRewardValue
 */
export interface OrderRewardValue {
    /**
     * Amount of the reward
     * @type {number}
     * @memberof OrderRewardValue
     */
    'denomination': number;
    /**
