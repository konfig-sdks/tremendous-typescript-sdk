...
import { OrdersRejectByIdResponseOrderPayment } from './orders-reject-by-id-response-order-payment';
import { OrdersRejectByIdResponseOrderReward } from './orders-reject-by-id-response-order-reward';

/**
 * An order wraps around the fulfilment of one or more rewards.
 * @export
 * @interface OrdersRejectByIdResponseOrder
 */
export interface OrdersRejectByIdResponseOrder {
    /**
     * Tremendous ID of the order
     * @type {string}
     * @memberof OrdersRejectByIdResponseOrder
     */
    'id': string;
    /**
     ...
     * @memberof OrdersRejectByIdResponseOrder
     */
    'status': OrdersRejectByIdResponseOrderStatusEnum;
    /**
     * 
     * @type {OrdersRejectByIdResponseOrderPayment}
     * @memberof OrdersRejectByIdResponseOrder
     */
    ...
    /**
     * 
     * @type {OrdersRejectByIdResponseOrderReward}
     * @memberof OrdersRejectByIdResponseOrder
     */
    'reward'?: OrdersRejectByIdResponseOrderReward;
}

type OrdersRejectByIdResponseOrderStatusEnum = 'CANCELED' | 'CART' | 'EXECUTED' | 'FAILED' | 'PENDING APPROVAL' | 'PENDING INTERNAL PAYMENT APPROVAL'
