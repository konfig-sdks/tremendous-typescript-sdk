 ...
 * @export
 * @interface OrganizationsGetListResponseOrganizationsInner
 */
export interface OrganizationsGetListResponseOrganizationsInner {
    /**
     * 
     * @type {string}
     * @memberof OrganizationsGetListResponseOrganizationsInner
     */
    'id'?: string;
    /**
     ...
     * @memberof OrganizationsGetListResponseOrganizationsInner
     */
    'status'?: OrganizationsGetListResponseOrganizationsInnerStatusEnum;
    /**
...
type OrganizationsGetListResponseOrganizationsInnerStatusEnum = 'PENDING' | 'APPROVED' | 'REJECTED'
