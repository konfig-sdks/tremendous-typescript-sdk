 ...
 * @export
 * @interface RewardsListAllRewardsResponseRewardsInnerDelivery
 */
export interface RewardsListAllRewardsResponseRewardsInnerDelivery {
    /**
     ...
     * @type {string}
     * @memberof RewardsListAllRewardsResponseRewardsInnerDelivery
     */
    'method': RewardsListAllRewardsResponseRewardsInnerDeliveryMethodEnum;
    /**
     ...
     * @memberof RewardsListAllRewardsResponseRewardsInnerDelivery
     */
    'status': RewardsListAllRewardsResponseRewardsInnerDeliveryStatusEnum;
}

type RewardsListAllRewardsResponseRewardsInnerDeliveryMethodEnum = 'EMAIL' | 'LINK' | 'PHONE'
type RewardsListAllRewardsResponseRewardsInnerDeliveryStatusEnum = 'SCHEDULED' | 'FAILED' | 'SUCCEEDED' | 'PENDING'
