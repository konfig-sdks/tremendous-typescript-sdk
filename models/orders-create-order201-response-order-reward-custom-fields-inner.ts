 ...
 * @export
 * @interface OrdersCreateOrder201ResponseOrderRewardCustomFieldsInner
 */
export interface OrdersCreateOrder201ResponseOrderRewardCustomFieldsInner {
    /**
     * Tremendous ID of the custom field
     * @type {string}
     * @memberof OrdersCreateOrder201ResponseOrderRewardCustomFieldsInner
     */
    'id'?: string;
    /**
