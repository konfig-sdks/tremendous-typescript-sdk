 ...
 * @export
 * @interface OrdersRejectByIdResponseOrderRewardCustomFieldsInner
 */
export interface OrdersRejectByIdResponseOrderRewardCustomFieldsInner {
    /**
     * Tremendous ID of the custom field
     * @type {string}
     * @memberof OrdersRejectByIdResponseOrderRewardCustomFieldsInner
     */
    'id'?: string;
    /**
