...
import { OrdersCreateOrder201ResponseOrderPayment } from './orders-create-order201-response-order-payment';
import { OrdersCreateOrder201ResponseOrderReward } from './orders-create-order201-response-order-reward';

/**
 * An order wraps around the fulfilment of one or more rewards.
 * @export
 * @interface OrdersCreateOrder201ResponseOrder
 */
export interface OrdersCreateOrder201ResponseOrder {
    /**
     * Tremendous ID of the order
     * @type {string}
     * @memberof OrdersCreateOrder201ResponseOrder
     */
    'id': string;
    /**
     ...
     * @memberof OrdersCreateOrder201ResponseOrder
     */
    'status': OrdersCreateOrder201ResponseOrderStatusEnum;
    /**
     * 
     * @type {OrdersCreateOrder201ResponseOrderPayment}
     * @memberof OrdersCreateOrder201ResponseOrder
     */
    ...
    /**
     * 
     * @type {OrdersCreateOrder201ResponseOrderReward}
     * @memberof OrdersCreateOrder201ResponseOrder
     */
    'reward'?: OrdersCreateOrder201ResponseOrderReward;
}

type OrdersCreateOrder201ResponseOrderStatusEnum = 'CANCELED' | 'CART' | 'EXECUTED' | 'FAILED' | 'PENDING APPROVAL' | 'PENDING INTERNAL PAYMENT APPROVAL'
