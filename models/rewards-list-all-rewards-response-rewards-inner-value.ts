 ...
 * 
 * @export
 * @interface RewardsListAllRewardsResponseRewardsInnerValue
 */
export interface RewardsListAllRewardsResponseRewardsInnerValue {
    /**
     * Amount of the reward
     * @type {number}
     * @memberof RewardsListAllRewardsResponseRewardsInnerValue
     */
    'denomination': number;
    /**
