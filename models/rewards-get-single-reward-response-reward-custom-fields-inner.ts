 ...
 * @export
 * @interface RewardsGetSingleRewardResponseRewardCustomFieldsInner
 */
export interface RewardsGetSingleRewardResponseRewardCustomFieldsInner {
    /**
     * Tremendous ID of the custom field
     * @type {string}
     * @memberof RewardsGetSingleRewardResponseRewardCustomFieldsInner
     */
    'id'?: string;
    /**
