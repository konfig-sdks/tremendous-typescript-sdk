...
import { OrderWithLinkPaymentRefund } from './order-with-link-payment-refund';
 ...
 * @export
 * @interface OrderWithLinkPayment
 */
export interface OrderWithLinkPayment {
    /**
     * Total price of the order before fees (in USD)
     * @type {number}
     * @memberof OrderWithLinkPayment
     */
    'subtotal'?: number;
    /**
    ...
    /**
     * 
     * @type {OrderWithLinkPaymentRefund}
     * @memberof OrderWithLinkPayment
     */
     ...
     * @memberof OrderWithLinkPayment
     */
    'channel'?: OrderWithLinkPaymentChannelEnum;
}

type OrderWithLinkPaymentChannelEnum = 'UI' | 'API' | 'EMBED' | 'DECIPHER' | 'QUALTRICS' | 'TYPEFORM' | 'SURVEY MONKEY'
