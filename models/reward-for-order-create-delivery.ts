 ...
 * @export
 * @interface RewardForOrderCreateDelivery
 */
export interface RewardForOrderCreateDelivery {
    /**
     ...
     * @type {string}
     * @memberof RewardForOrderCreateDelivery
     */
    'method'?: RewardForOrderCreateDeliveryMethodEnum;
}

type RewardForOrderCreateDeliveryMethodEnum = 'EMAIL' | 'LINK' | 'PHONE'
