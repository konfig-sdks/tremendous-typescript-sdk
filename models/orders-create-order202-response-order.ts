...
import { OrdersCreateOrder202ResponseOrderPayment } from './orders-create-order202-response-order-payment';
import { OrdersCreateOrder202ResponseOrderRewardsInner } from './orders-create-order202-response-order-rewards-inner';

/**
 * An order wraps around the fulfilment of one or more rewards.
 * @export
 * @interface OrdersCreateOrder202ResponseOrder
 */
export interface OrdersCreateOrder202ResponseOrder {
    /**
     * Tremendous ID of the order
     * @type {string}
     * @memberof OrdersCreateOrder202ResponseOrder
     */
    'id': string;
    /**
     ...
     * @memberof OrdersCreateOrder202ResponseOrder
     */
    'status': OrdersCreateOrder202ResponseOrderStatusEnum;
    /**
     * 
     * @type {OrdersCreateOrder202ResponseOrderPayment}
     * @memberof OrdersCreateOrder202ResponseOrder
     */
    ...
    /**
     * 
     * @type {Array<OrdersCreateOrder202ResponseOrderRewardsInner>}
     * @memberof OrdersCreateOrder202ResponseOrder
     */
    'rewards'?: Array<OrdersCreateOrder202ResponseOrderRewardsInner>;
}

type OrdersCreateOrder202ResponseOrderStatusEnum = 'CANCELED' | 'CART' | 'EXECUTED' | 'FAILED' | 'PENDING APPROVAL' | 'PENDING INTERNAL PAYMENT APPROVAL'
