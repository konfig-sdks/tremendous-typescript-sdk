 ...
 * @export
 * @interface OrdersCreateOrderRequestRewardCustomFieldsInner
 */
export interface OrdersCreateOrderRequestRewardCustomFieldsInner {
    /**
     * Tremendous ID of the custom field
     * @type {string}
     * @memberof OrdersCreateOrderRequestRewardCustomFieldsInner
     */
    'id'?: string;
    /**
