 ...
 * @export
 * @interface OrderWithoutLinkRewardCustomFieldsInner
 */
export interface OrderWithoutLinkRewardCustomFieldsInner {
    /**
     * Tremendous ID of the custom field
     * @type {string}
     * @memberof OrderWithoutLinkRewardCustomFieldsInner
     */
    'id'?: string;
    /**
