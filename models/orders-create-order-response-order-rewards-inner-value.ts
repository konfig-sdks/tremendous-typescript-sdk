 ...
 * 
 * @export
 * @interface OrdersCreateOrderResponseOrderRewardsInnerValue
 */
export interface OrdersCreateOrderResponseOrderRewardsInnerValue {
    /**
     * Amount of the reward
     * @type {number}
     * @memberof OrdersCreateOrderResponseOrderRewardsInnerValue
     */
    'denomination': number;
    /**
