...
import { OrdersGetOrderByIdResponseOrderPayment } from './orders-get-order-by-id-response-order-payment';
import { OrdersGetOrderByIdResponseOrderReward } from './orders-get-order-by-id-response-order-reward';

/**
 * An order wraps around the fulfilment of one or more rewards.
 * @export
 * @interface OrdersGetOrderByIdResponseOrder
 */
export interface OrdersGetOrderByIdResponseOrder {
    /**
     * Tremendous ID of the order
     * @type {string}
     * @memberof OrdersGetOrderByIdResponseOrder
     */
    'id': string;
    /**
     ...
     * @memberof OrdersGetOrderByIdResponseOrder
     */
    'status': OrdersGetOrderByIdResponseOrderStatusEnum;
    /**
     * 
     * @type {OrdersGetOrderByIdResponseOrderPayment}
     * @memberof OrdersGetOrderByIdResponseOrder
     */
    ...
    /**
     * 
     * @type {OrdersGetOrderByIdResponseOrderReward}
     * @memberof OrdersGetOrderByIdResponseOrder
     */
    'reward'?: OrdersGetOrderByIdResponseOrderReward;
}

type OrdersGetOrderByIdResponseOrderStatusEnum = 'CANCELED' | 'CART' | 'EXECUTED' | 'FAILED' | 'PENDING APPROVAL' | 'PENDING INTERNAL PAYMENT APPROVAL'
