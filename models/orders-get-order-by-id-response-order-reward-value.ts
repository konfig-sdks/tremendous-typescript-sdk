 ...
 * 
 * @export
 * @interface OrdersGetOrderByIdResponseOrderRewardValue
 */
export interface OrdersGetOrderByIdResponseOrderRewardValue {
    /**
     * Amount of the reward
     * @type {number}
     * @memberof OrdersGetOrderByIdResponseOrderRewardValue
     */
    'denomination': number;
    /**
