 ...
 * @export
 * @interface OrderWithLinkRewardsInnerDelivery
 */
export interface OrderWithLinkRewardsInnerDelivery {
    /**
     ...
     * @type {string}
     * @memberof OrderWithLinkRewardsInnerDelivery
     */
    'method': OrderWithLinkRewardsInnerDeliveryMethodEnum;
    /**
     ...
     * @memberof OrderWithLinkRewardsInnerDelivery
     */
    'status': OrderWithLinkRewardsInnerDeliveryStatusEnum;
    /**
...
type OrderWithLinkRewardsInnerDeliveryMethodEnum = 'EMAIL' | 'LINK' | 'PHONE'
type OrderWithLinkRewardsInnerDeliveryStatusEnum = 'SCHEDULED' | 'FAILED' | 'SUCCEEDED' | 'PENDING'
