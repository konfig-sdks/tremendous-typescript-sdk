 ...
 * 
 * @export
 * @interface RewardWithLinkValue
 */
export interface RewardWithLinkValue {
    /**
     * Amount of the reward
     * @type {number}
     * @memberof RewardWithLinkValue
     */
    'denomination': number;
    /**
