...
import { OrdersCreateOrderResponseOrderPayment } from './orders-create-order-response-order-payment';
import { OrdersCreateOrderResponseOrderRewardsInner } from './orders-create-order-response-order-rewards-inner';

/**
 * An order wraps around the fulfilment of one or more rewards.
 * @export
 * @interface OrdersCreateOrderResponseOrder
 */
export interface OrdersCreateOrderResponseOrder {
    /**
     * Tremendous ID of the order
     * @type {string}
     * @memberof OrdersCreateOrderResponseOrder
     */
    'id': string;
    /**
     ...
     * @memberof OrdersCreateOrderResponseOrder
     */
    'status': OrdersCreateOrderResponseOrderStatusEnum;
    /**
     * 
     * @type {OrdersCreateOrderResponseOrderPayment}
     * @memberof OrdersCreateOrderResponseOrder
     */
    ...
    /**
     * 
     * @type {Array<OrdersCreateOrderResponseOrderRewardsInner>}
     * @memberof OrdersCreateOrderResponseOrder
     */
    'rewards'?: Array<OrdersCreateOrderResponseOrderRewardsInner>;
}

type OrdersCreateOrderResponseOrderStatusEnum = 'CANCELED' | 'CART' | 'EXECUTED' | 'FAILED' | 'PENDING APPROVAL' | 'PENDING INTERNAL PAYMENT APPROVAL'
