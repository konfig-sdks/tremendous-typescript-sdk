 ...
 * @export
 * @interface OrdersCreateOrder201ResponseOrderPaymentRefund
 */
export interface OrdersCreateOrder201ResponseOrderPaymentRefund {
    /**
     * Total amount of the order refunds (in USD)
     * @type {number}
     * @memberof OrdersCreateOrder201ResponseOrderPaymentRefund
     */
    'total': number;
}
