 ...
 * 
 * @export
 * @interface RewardForOrderCreateValue
 */
export interface RewardForOrderCreateValue {
    /**
     * Amount of the reward
     * @type {number}
     * @memberof RewardForOrderCreateValue
     */
    'denomination': number;
    /**
