 ...
 * @export
 * @interface OrdersCreateOrderResponseOrderRewardsInnerDelivery
 */
export interface OrdersCreateOrderResponseOrderRewardsInnerDelivery {
    /**
     ...
     * @type {string}
     * @memberof OrdersCreateOrderResponseOrderRewardsInnerDelivery
     */
    'method': OrdersCreateOrderResponseOrderRewardsInnerDeliveryMethodEnum;
    /**
     ...
     * @memberof OrdersCreateOrderResponseOrderRewardsInnerDelivery
     */
    'status': OrdersCreateOrderResponseOrderRewardsInnerDeliveryStatusEnum;
    /**
...
type OrdersCreateOrderResponseOrderRewardsInnerDeliveryMethodEnum = 'EMAIL' | 'LINK' | 'PHONE'
type OrdersCreateOrderResponseOrderRewardsInnerDeliveryStatusEnum = 'SCHEDULED' | 'FAILED' | 'SUCCEEDED' | 'PENDING'
