 ...
 * @export
 * @interface MembersListMembersResponseMembersInner
 */
export interface MembersListMembersResponseMembersInner {
    /**
     * 
     * @type {string}
     * @memberof MembersListMembersResponseMembersInner
     */
    'id': string;
    /**
     ...
     * @memberof MembersListMembersResponseMembersInner
     */
    'role': MembersListMembersResponseMembersInnerRoleEnum;
    /**
     ...
     * @memberof MembersListMembersResponseMembersInner
     */
    'status': MembersListMembersResponseMembersInnerStatusEnum;
    /**
...
type MembersListMembersResponseMembersInnerRoleEnum = 'MEMBER' | 'ADMIN' | 'DELETED'
type MembersListMembersResponseMembersInnerStatusEnum = 'REGISTERED' | 'INVITED'
