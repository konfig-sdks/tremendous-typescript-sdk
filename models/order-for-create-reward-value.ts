 ...
 * 
 * @export
 * @interface OrderForCreateRewardValue
 */
export interface OrderForCreateRewardValue {
    /**
     * Amount of the reward
     * @type {number}
     * @memberof OrderForCreateRewardValue
     */
    'denomination': number;
    /**
