 ...
 * @export
 * @interface InvoicesGetAllResponseInvoicesInner
 */
export interface InvoicesGetAllResponseInvoicesInner {
    /**
     * The invoice number
     * @type {string}
     * @memberof InvoicesGetAllResponseInvoicesInner
     */
    'id': string;
    /**
     ...
     * @memberof InvoicesGetAllResponseInvoicesInner
     */
    'status': InvoicesGetAllResponseInvoicesInnerStatusEnum;
    /**
...
type InvoicesGetAllResponseInvoicesInnerStatusEnum = 'DELETED' | 'PAID' | 'OPEN' | 'MARKED_AS_PAID'
