...
import { OrderPaymentRefund } from './order-payment-refund';
...
export interface OrderPayment {
     ...
     * @memberof OrderPayment
     */
    'channel'?: OrderPaymentChannelEnum;
}

type OrderPaymentChannelEnum = 'UI' | 'API' | 'EMBED' | 'DECIPHER' | 'QUALTRICS' | 'TYPEFORM' | 'SURVEY MONKEY'
